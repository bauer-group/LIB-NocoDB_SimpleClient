...
from nocodb_simple_client import NocoDBTable, NocoDBException
...
class TestNocoDBTable:
    ...
    def test_get_records(self, table, sample_records):
        ...
        table.client.get_records.assert_called_once_with(
            "test-table-id", None, None, None, 10
        )
    ...
    def test_get_record(self, table, sample_record):
        ...
        assert record["Id"] == 1
        table.client.get_record.assert_called_once_with(
            "test-table-id", 123, ["Id", "Name"]
        )

...
from nocodb_simple_client.exceptions import ValidationException, AuthenticationException
...
class TestInputValidation:
    ...
    def test_where_clause_validation(self):
        ...
        assert validate_where_clause("(Age,gt,21)~and(Status,eq,Active)") == "(Age,gt,21)~and(Status,eq,Active)"
...
class TestAuthenticationSecurity:
    ...
    def test_api_token_masking_in_logs(self):
        ...
        config = NocoDBConfig(
            ...
            api_token="secret_api_token_123456"
        )
...
class TestErrorInformationLeakage:
    ...
    def test_error_message_sanitization(self, mock_get):
        ...
        mock_response.json.return_value = {
            ...
            'message': 'Connection failed to database at internal-db-server:5432 with user admin_user',

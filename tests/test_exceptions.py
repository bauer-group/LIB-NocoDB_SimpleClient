...
class TestExceptions:
    ...
    def test_record_not_found_exception(self):
        ...
        exception = RecordNotFoundException(error, message)
    ...
    def test_exception_str_representation(self):
        ...
        record_exc = RecordNotFoundException("RECORD_NOT_FOUND", "Record does not exist")
        
        assert str(nocodb_exc) == "VALIDATION_ERROR: Invalid field value"
        assert str(record_exc) == "RECORD_NOT_FOUND: Record does not exist"
    ...
    def test_exception_raising_and_catching(self):
        ...
        with pytest.raises(RecordNotFoundException) as exc_info:
            raise RecordNotFoundException("RECORD_NOT_FOUND", "Record not found")
    ...
    def test_catching_as_base_exception(self):
        ...
        try:
            raise RecordNotFoundException("RECORD_NOT_FOUND", "Not found")
    ...
    def test_exception_in_exception_hierarchy(self):
        ...
        record_exc = RecordNotFoundException("RECORD_NOT_FOUND", "Not found")

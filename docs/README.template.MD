...
[![CI](https://github.com/{{REPO_FULL_NAME}}/workflows/CI/badge.svg)](https://github.com/{{REPO_FULL_NAME}}/actions)
[![codecov](https://codecov.io/gh/{{REPO_FULL_NAME}}/branch/{{CURRENT_BRANCH}}/graph/badge.svg)](https://codecov.io/gh/{{REPO_FULL_NAME}})
...
# Run with coverage
pytest --cov=src/nocodb_simple_client
